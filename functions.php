...
function rustikal_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'rustikal_custom_background_args',
			array(
 ...
 */
function rustikal_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'rustikal' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'rustikal' ),
...
add_action( 'widgets_init', 'rustikal_widgets_init' );
